<template>
    <div class="footer">
      <div class="footer-content p-d-flex p-jc-between">
        <div class="left-section">
          <h4>KOSOVA ESTATE</h4>
          <div class="kosova-description">
        ...
        <div class="menu-items">
          ...
          <router-link to="/manage-staff" class="footer-link">Manage Staff</router-link>
          <router-link to="/manage-clients" class="footer-link">Manage Clients</router-link>
      ...
      <div class="footer-copyright">
        &copy; 2024 Kosova Estate. All rights reserved.
      </div>
    </div>
  </template>
