...
public function login(Request $request)
{
    ...
    // Retrieve the user with the role relationship
    $user = Users::with('role')->where('username', $request->username)->first();
  ...
  public function registerStaff(Request $request)
    {
        ...
        // $ability = Ability::where('ability_name', 'fill-form')->first();
